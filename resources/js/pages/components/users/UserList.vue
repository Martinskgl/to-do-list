      ...
      <table class="table table-hover align-middle">
        ...
        <tbody>
          <tr v-for="user in users" :key="user.id">
            ...
            <td>
              <button @click="editUser(user)" class="btn btn-sm btn-outline-primary me-2" title="Editar">
                <i class="fa-solid fa-pencil"></i>
              </button>
              <button @click="deleteUser(user.id)" class="btn btn-sm btn-outline-danger" title="Excluir">
